...
echo "---Instalando dependencias---"
 dpkg --add-architecture i386; apt update;  apt install -y curl wget file tar bzip2 gzip unzip bsdmainutils python3 util-linux ca-certificates binutils bc jq lib32gcc-s1 lib32stdc++6 libsdl2-2.0-0:i386 openjdk-17-jre-headless ;  apt upgrade 
